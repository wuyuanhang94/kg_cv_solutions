...
best_dice = .0
mean = np.array([0.63959578, 0.47326392, 0.68438224])
std = np.array([0.1633776, 0.22941419, 0.14310585])
...
train_transforms = A.Compose([
    ...
    A.Cutout(num_holes=3, max_h_size=int(0.08*cfg['img_size']), max_w_size=int(0.08*cfg['img_size']), p=cfg['p']),
...
def prepare_dataloader(train_ids, val_ids):
    ...
    val_dataset = HuBMAPDataset(val_ids, train=False, tfms=A.Resize(cfg['img_size'], cfg['img_size']))
