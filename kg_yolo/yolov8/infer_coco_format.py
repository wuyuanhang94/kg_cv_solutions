...
train = glob.glob("/home/yiw/kg_yolo/input/train/*")
test = glob.glob("/home/yiw/kg_yolo/input/test/*")

annotations = {}

# Open the annotations file
with open('/home/yiw/kg_yolo/input/polygons.jsonl', 'r') as f:
    for line in f:
...
model_paths = ['/home/yiw/kg_yolo/yolov8/runs/segment/train0_f0_0.390/weights/best_f0.pt',
               '/home/yiw/kg_yolo/yolov8/runs/segment/train0_f0_0.396/weights/best_f0.pt',
...
for test_name in tqdm(test_names):
    img = Image.open(os.path.join("/home/yiw/kg_yolo/input/train", test_name))
    img = np.array(img)
    h, w, _ = img.shape
