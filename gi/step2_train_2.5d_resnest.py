...
class CFG:
    ...
    exp_name      = '2.5D'
    comment       = 'unetpp-resnest101e-320*384_ep30'
...
#         A.Resize(*CFG.img_size, interpolation=cv2.INTER_NEAREST),
        ...
        A.OneOf([
            A.Affine(rotate=(-10, 10), translate_percent=(0.0, 0.25), shear=(-3, 3), p=0.25),
            A.GaussianBlur(blur_limit=(3, 7), p=0.25),
        ], p=0.15),

        A.RandomGridShuffle(grid=(2, 2), p=0.15),

        A.CoarseDropout(max_holes=20, max_height=CFG.img_size[0]//25, max_width=CFG.img_size[1]//25,
                         min_holes=7, fill_value=0.99, mask_fill_value=0.00001, p=0.5),
        ], p=1.0),
...
def criterion(y_pred, y_true):
    return 0.1*BCELoss(y_pred, y_true) + 0.9*TverskyLoss(y_pred, y_true)
