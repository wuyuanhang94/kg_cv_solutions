...
data_transforms = {
    "train": A.Compose([
        ...
        A.RandomResizedCrop(height=640, width=704, scale=(0.1, 1), interpolation=cv2.INTER_NEAREST),
        ...
        A.CoarseDropout(max_holes=25, max_height=CFG.img_size[0]//40, max_width=CFG.img_size[1]//40,
                         min_holes=10, fill_value=0.29, mask_fill_value=0, p=0.6),
        ], p=1.0),
