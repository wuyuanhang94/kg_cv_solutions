...
class CFG:
    ...
    exp_name      = '2.5D'
    comment       = 'unetpp-efficientnet_b4-320*384_ep30'
...
#         A.Resize(*CFG.img_size, interpolation=cv2.INTER_NEAREST),
        A.RandomResizedCrop(height=320, width=384, scale=(0.85, 1), interpolation=cv2.INTER_NEAREST),
        ...
        A.CoarseDropout(max_holes=16, max_height=CFG.img_size[0]//25, max_width=CFG.img_size[1]//25,
                         min_holes=6, fill_value=0.99, mask_fill_value=0, p=0.5),
        ], p=1.0),
