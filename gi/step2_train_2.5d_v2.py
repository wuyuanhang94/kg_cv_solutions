...
class CFG:
    ...
    exp_name      = '2.5D'
    comment       = 'unetpp-efficientnet_b5-320*384_ep10'
...
#         A.Resize(*CFG.img_size, interpolation=cv2.INTER_NEAREST),
        ...
        A.CoarseDropout(max_holes=23, max_height=CFG.img_size[0]//20, max_width=CFG.img_size[1]//20,
                         min_holes=8, fill_value=0.9, mask_fill_value=0.0000001, p=0.5),
        ], p=1.0),
...
def criterion(y_pred, y_true):
    return 0.2*BCELoss(y_pred, y_true) + 0.8*TverskyLoss(y_pred, y_true)
