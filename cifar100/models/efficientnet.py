...
class SE(nn.Module):
    def __init__(self, in_channels, se_channels):
        ...
        self.se1 = nn.Conv2d(in_channels, se_channels, kernel_size=1, bias=False)
        self.se2 = nn.Conv2d(se_channels, in_channels, kernel_size=1, bias=False)
...
class Block(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
        ...
        # Skip connection if in and out shapes are the same
