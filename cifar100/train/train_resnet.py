...
# acc 极限到 74% 与别人的不同 可能是因为data augmentation 做的不够好 导致泛化能力差
...
if args.resume:
    ...
    checkpoint = torch.load('../checkpoint/cifar100-resnet101.pth')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, '../checkpoint/cifar100-resnet101.pth')
        best_acc = acc
