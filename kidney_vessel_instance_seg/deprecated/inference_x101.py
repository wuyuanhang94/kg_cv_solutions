...
best_model = ["model_best.pth", "model_best_fold2.pth", "model_best_fold4.pth"]
...
mdl_path = "/home/yiw/kg/output_x101_finetune"
best_model = ["model_best_19552.pth"]
for b_m in best_model:
    model_name=b_m
    model_ths=THRESHOLDS
    BEST_MODELS.append(model_name)
