...
cfg = {
    ...
    'img_size': 280, # if device_name != 'TITAN V' else 512,
    'epochs': 15,
    'train_batch_size': 8 if device_name != 'TITAN V' else 16,
    'val_batch_size': 4, #if device_name != 'TITAN V' else 32,
    'T_0': 10,
    'lr': 1e-4,
    'min_lr': 1e-6,
    'accum_iter': 4,
...
def main_loop(resume, adam):
    ...
    for fold, (train_idx, val_idx) in enumerate(folds):
        ...
        epochs = 9 if resume else cfg['epochs']
